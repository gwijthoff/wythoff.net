...
Here's some examples, please be aware that these styles only take effect when the page width is over 1300px.[^1]

[^1]: This is a test of a footnote.

![](hermit.png)

{{< figure src="/images/hermit.png" alt="image" caption="figure-normal (without any classes)" >}}
